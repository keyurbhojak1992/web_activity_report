...
print('[BOOT 1] Imports completed', flush=True)

# ==========================================
# 0. PAGE CONFIGURATION
# ==========================================
# Keep this before all other Streamlit API calls.
st.set_page_config(page_title="Diamond WebLog Processor", layout="centered")
print("[BOOT 2] Page configuration completed", flush=True)

# ==========================================
# 1. UI & CONTROL FLAGS
# ==========================================
st.title("💎 Weblog Activity Report Generator")
st.caption("Build: full-app-debug-2026-07-14")
print("[BOOT 3] Title rendered", flush=True)
...
print("[BOOT 4] Uploaders rendered", flush=True)

# ==========================================
# 3. GENERATION LOGIC
# ==========================================
generate_clicked = st.button("Generate Report")
print(f"[BOOT 5] Generate button rendered; clicked={generate_clicked}", flush=True)
